...
<head>
    ...
    <link rel="stylesheet" href="<?= htmlspecialchars($action->helper->loadcss('cv_content_3.css')) ?>">
...
<div class="resume">
<header>
    <h1><strong><?= htmlspecialchars(@$resume['name']) ?></strong></h1>
    ...
    <section class="contact-info">
        ...
        <ul>
            ...
            <li>Phone: <?= htmlspecialchars($contact->mobile) ?></li>
