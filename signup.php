    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                $imageUrl = htmlspecialchars($action->helper->loadimage('signup2.jpg'), ENT_QUOTES, 'UTF-8');
                ...
                <?php
                $formAction = htmlspecialchars($action->helper->url('action/signup'), ENT_QUOTES, 'UTF-8');
                ...
                <form class="login100-form validate-form" method="post" action="<?php echo $formAction; ?>">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Full name is required">
                        <input class="input100" type="text" name="full_name" placeholder="Your Name" required>
...
<div class="wrap-input100 validate-input" data-validate="Password is required">
    ...
    <span class="toggle-password">
        <i class="fa fa-eye" id="toggleConfirmPassword" aria-hidden="true"></i>
                    ...
                    <div>
                        <h2><a class="txt2" href="<?php echo htmlspecialchars($action->helper->url('login'), ENT_QUOTES, 'UTF-8'); ?>">
